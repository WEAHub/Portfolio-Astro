...
export default function RouterLink(props: Route) {
  const { active, section, title } = props;
  return (
    <a className={`group flex items-center py-3 cursor-pointer ${ active ? 'active' : null}`} href={section}>
